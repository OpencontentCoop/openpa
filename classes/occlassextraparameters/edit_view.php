...
class OpenPAEditViewClassExtraParameters extends OCClassExtraParametersHandlerBase
{
    ...
    {
        return "Visualizzazione degli attributi nella vista di modifica (template edit)";
    }
