...
class OpenPADFSFileHandlerDFSNFS implements eZDFSFileHandlerDFSBackendInterface
{
    public function __construct()
    {
        $mountPointPath = OpenPADFSFileHandlerDFSRegistry::getCurrentInstanceIni( 'file.ini' )->variable( 'eZDFSClusteringSettings', 'MountPointPath' );
        ...
        $this->filePermissionMask = octdec( OpenPADFSFileHandlerDFSRegistry::getCurrentInstanceIni()->variable( 'FileSettings', 'StorageFilePermissions' ) );
    }
