...
ViewName[singolo_img]=Solo immagine grande (home)
ViewName[singolo_imgtit]=Imm. grande e titolo (home)
ViewName[singolo_img_interne]=Solo immagine grande (interne)
ViewName[singolo_imgtit_interne]=Imm. grande e titolo (interne)
ViewName[singolo_box]=Box (titolo, immagine e abstract)
...
ViewName[lista_box]=Box normale
...
[Lista3]
Name=Lista di oggetti (assegnati singolarmente) - MAX 4
...
ViewName[lista_box2]=Box a colonne (livello1)
ViewName[lista_box3]=Box di news
ViewName[lista_box4]=Box ultimi figli
...
ViewList[]=lista_tab
ViewName[lista_accordion_manual]=Schede (accordion)
ViewName[lista_box2]=Box a colonne
ViewName[lista_tab]=Schede (tab)
