<h4 class="attributetype">{"Single/Multiple choice"|i18n( 'survey' )}</h4>
...
<select class="form-control" name="{$prefix_attribute}_ezsurvey_question_{$question.id}_num_{$attribute_id}">
...
<tr class="{$class}">
  ...
  <td colspan="4"><input class="form-control" name="{$prefix_attribute}_ezsurvey_mc_{$question.id}_{$option.id}_label_{$attribute_id}" type="text" value="{$option.label|wash('xhtml')}" size="30" /></td>
  <td><input class="form-control" name="{$prefix_attribute}_ezsurvey_mc_{$question.id}_{$option.id}_value_{$attribute_id}" type="text" value="{$option.value|wash('xhtml')}" size="5" /></td>
  <td>
  ...
  <td><input class="form-control" name="{$prefix_attribute}_ezsurvey_mc_{$question.id}_{$option.id}_tab_order_{$attribute_id}" type="text" size="2" value="{$option.id|wash('xhtml')}" /></td>
</tr>
{/foreach}
{if $question.extra_info.enabled|eq(1)}
  <tr class="bglight">
	...
	<td colspan="4">
	  <input class="form-control" name="{$prefix_attribute}_ezsurvey_mc_{$question.id}_extra_label_{$attribute_id}" type="text" value="{$question.extra_info.label|wash('xhtml')}" size="30" />
	</td>
	<td rowspan="3">
	  <input class="form-control" name="{$prefix_attribute}_ezsurvey_mc_{$question.id}_extra_value_{$attribute_id}" type="text" value="{$question.extra_info.value|wash('xhtml')}" size="5" />
	</td>
	<td rowspan="3">
	  <div class="text-center">
		{if or($question.num|eq(1), $question.num|eq(2), $question.num|eq(5), $question.num|eq(0))}
  ...
  <tr class="bgdark">
	<td>
	  <input class="form-control" name="{$prefix_attribute}_ezsurvey_mc_{$question.id}_extra_default_value_{$attribute_id}" type="text" value="{$question.extra_info.default_value|wash('xhtml')}" size="30" />
	</td>
	<td>
	...
	<td>
	  <input id="{$prefix_attribute}_ezsurvey_mc_{$question.id}_extra_column_{$attribute_id}" class="form-control" name="{$prefix_attribute}_ezsurvey_mc_{$question.id}_extra_column_{$attribute_id}" type="text" value="{$question.extra_info.column|wash('xhtml')}" size="5" />
	</td>
	<td>
	  <input class="form-control" name="{$prefix_attribute}_ezsurvey_mc_{$question.id}_extra_row_{$attribute_id}" type="text" value="{$question.extra_info.row|wash('xhtml')}" size="5" />
	</td>
  </tr>
{/if}
</table>
