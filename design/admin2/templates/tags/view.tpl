<div class="context-block">
    ...
    <div class="box-content">
        <div class="context-information">
            <p class="left modified">{'Last modified'|i18n( 'extension/eztags/tags/view' )}: {$tag.modified|l10n(shortdatetime)} ({'Tag ID'|i18n( 'extension/eztags/tags/view' )}: {$tag.id}) <code>{$tag.remote_id|wash()}]</code></p>
