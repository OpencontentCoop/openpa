...
{default exclude_remote_assignments=false()}
    ...
    <table class="list-edit-tools" cellspacing="0" cellpadding="0">
    <tr>
        <th width="25%">{"Location"|i18n("design/standard/content/edit")}</th>
    ...
    {section show=$:has_top_levels|not}
        ...
        <th width="20%">{"Move"|i18n("design/standard/content/edit")}</th>
    {/section}
    </tr>
...
{*     {/section}*}
        ...
        {section show=$:has_top_levels|not}
        <td class="{$Node:sequence}" align="right">
		{* pulsante della collocazione multipla *}
