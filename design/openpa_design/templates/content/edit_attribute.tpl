{def $AttributiNonEditabili = openpaini( 'Editor', 'AttributiNonEditabili', array())}
...
<div class="block ezcca-edit-datatype-{$attribute.data_type_string} ezcca-edit-{$attribute_identifier}{if $AttributiNonEditabili|contains(concat($class.identifier,'/',$attribute_identifier))} hidden{/if}">
