                    ...
                    <tr class="{$style}" data-identifier="{$identifier}">
                        ...
                        <td style="white-space: nowrap">
                            {if $is_edit|not()}
                                ...
                                <button type="submit" class="button btn" name="RemoveDefinition" value="{$identifier}"><i class="fa fa-trash"></i> <span class="u-hiddenVisually sr-only">Elimina</span></button>
                    ...
                    <tr class="{$style}" data-identifier="{$class_identifier}">
                        ...
                        <td style="white-space: nowrap">
                            {if $is_edit|not()}
                                ...
                                <button type="submit" class="button btn" name="RemoveRule" value="{$class_identifier}"><i class="fa fa-trash"></i> <span class="u-hiddenVisually sr-only">Elimina</span></button>
