...
<tr>
    <td><label><input type="radio" name="SettingPlacement" checked="checked" value="siteaccess">{'Siteaccess setting'|i18n('design/admin/settings')}</label></td>
    <td>
...
<tr>
    <td><label><input type="radio" disabled="disabled" name="SettingPlacement" value="{$extension_name}">{$extension_name}</label></td>
    <td>
...
{/foreach}
<tr>
    <td><label><input type="radio"  disabled="disabled" name="SettingPlacement" value="override">{'Override setting (global)'|i18n( 'design/admin/settings' )}</label></td>
    <td>
